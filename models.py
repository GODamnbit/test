...
class Bus(db.Model):
    ...
    bus_id = db.Column(db.Integer, nullable=False, primary_key=True)
...
class Route_station(db.Model):
    ...
    route_station = db.Column(db.Integer, primary_key=True, autoincrement=True)
    route_id = db.Column(db.Integer)
    station_id = db.Column(db.Integer)
    station_order = db.Column(db.Boolean)
...
class Station(db.Model):
    ...
    def __init__(self, station_name, station_type, density, longitude, latitude, delete_type=0):
...
class User(db.Model):
    ...
    user_id = db.Column(db.Integer, nullable=False, primary_key=True, comment='用户编号')
